  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">Rekapitulasi Data Mahasiswa dari KRS </h1>
      </div>
      {/* <div>Mahasiswa yang sudah KRS</div>
      <div>Mahasiswa yang belum KRS</div>
      <div>Mahasiswa yang mengambil TA</div>
      <div>Mahasiswa yang perpanjangan TA</div>
      <div>Mahasiswa yang mengambil PKL</div> */}
      <div className="flex justify-between flex-wrap gap-4">
        <UserCard type="Mahasiswa yang sudah KRS" />
